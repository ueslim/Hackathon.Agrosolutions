...
{
    Task<List<FarmWithFieldsResponse>> GetAllFarmsWithFieldsAsync(Guid userId, CancellationToken ct);
    ...
    Task<FarmResponse?> GetFarmByIdAsync(Guid userId, Guid farmId, CancellationToken ct);
}
